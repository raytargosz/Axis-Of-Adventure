...
namespace Opsive.UltimateCharacterController.Character
{
    ...
    public class CharacterLocomotion : StateBehavior
    {
        ...
        [SerializeField] protected bool m_GroundDetection = true;
        ...
        public bool GroundDetection { get => m_GroundDetection; set => m_GroundDetection = value; }
        ...
        protected Objects.IRigidbodyMovingPlatform m_MovingPlatformRigidbody;
        ...
        public void PreMove()
        {
            ...
            if (m_MovingPlatform != null) {
                ...
                if (m_AlignToUpDirection) {
                    var movingPlatformRotation = m_MovingPlatformRigidbody != null ? m_MovingPlatformRigidbody.TargetRotation : m_MovingPlatform.rotation;
                ...
                if (m_MovingPlatformRigidbody != null) {
                    m_MovingPlatformMovement = MathUtility.TransformPoint(m_MovingPlatformRigidbody.TargetPosition, m_MovingPlatformRigidbody.TargetRotation, m_MovingPlatformRelativePosition) -
        ...
        protected virtual void ApplyRotation()
        {
            ...
            if (m_MovingPlatform != null) {
                var movingPlatformRotation = m_MovingPlatformRigidbody != null ? m_MovingPlatformRigidbody.TargetRotation : m_MovingPlatform.rotation;
                m_MovingPlatformRotationOffset = MathUtility.InverseTransformQuaternion(m_Rigidbody.rotation * m_DesiredRotation, movingPlatformRotation);
                if (m_AlignToUpDirection) {
        ...
        private void DetectGround(bool sendGroundedEvents = true)
        {
            ...
            var grounded = false;
            var rigidbodyRotation = m_Rigidbody.rotation * m_DesiredRotation;
            ...
            var localMovingPlatformMovement = m_MovingPlatformRigidbody != null ? MathUtility.InverseTransformDirection(m_MovingPlatformMovement, rigidbodyRotation) : Vector3.zero;
            var hitCount = CombinedCast(targetPosition, m_GravityDirection, 
                (stickyGround ? (m_StickToGroundDistance + Mathf.Abs(localDesiredMovement.y)) : Mathf.Abs(localDesiredMovement.y)) + 
                m_SkinWidth + castOffset + localMovingPlatformMovement.y + c_ColliderSpacing);
            if (hitCount > 0) {
                for (int i = 0; i < hitCount; ++i) {
                    var closestRaycastHit = QuickSelect.SmallestK(m_CombinedCastResults, hitCount, i, m_CastHitComparer);
                    if (closestRaycastHit.distance == 0) {
                    ...
                    distance -= localMovingPlatformMovement.y;
        ...
        protected virtual void ApplyPosition()
        {
            ...
            if (m_MovingPlatform != null) {
                if (m_MovingPlatformRigidbody != null) {
                    m_MovingPlatformRelativePosition = MathUtility.InverseTransformPoint(m_MovingPlatformRigidbody.TargetPosition,
                                                        m_MovingPlatformRigidbody.TargetRotation, m_Rigidbody.position + m_DesiredMovement);
                } else {
        ...
        public virtual bool SetMovingPlatform(Transform movingPlatform, bool platformOverride = true)
        {
            ...
            if (m_MovingPlatform != null) {
                m_MovingPlatformRigidbody = m_MovingPlatform.gameObject.GetCachedComponent<Objects.IRigidbodyMovingPlatform>();

                if (m_MovingPlatformRigidbody != null) {
                    m_MovingPlatformRelativePosition = MathUtility.InverseTransformPoint(m_MovingPlatformRigidbody.TargetPosition, 
                                                        m_MovingPlatformRigidbody.TargetRotation, m_Rigidbody.position);
                } else {
                ...
                m_MovingPlatformRigidbody = null;
