    ...
    public abstract class ThirdPerson : ViewType
    {
        ...
        public override Vector3 Move(bool immediateUpdate)
        {
            ...
            if (immediateUpdate) {
                ...
                if (!m_CharacterLocomotion.InstantRigidbodyMove) {
                    startPosition += m_CharacterLocomotion.MovingPlatformMovement;
                }
                targetPosition = Vector3.SmoothDamp(startPosition, lookPosition, ref m_SmoothPositionVelocity, m_PositionSmoothing);
            }
